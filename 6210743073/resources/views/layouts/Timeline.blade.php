<section class="grid grid-rows-4 grid-flow-col gap-4 justify-center items-center m-10  dark:bg-gray-900  lg:py-12 lg:flex lg:justify-center">
    <div class="shadow-lg rounded-2xl w-64 p-4 py-6 bg-black">
        <div class="flex flex-col items-center justify-center">
            ...
            <p class="text-white text-xl font-medium mb-4 mt-4">
                Justice
            </p>
