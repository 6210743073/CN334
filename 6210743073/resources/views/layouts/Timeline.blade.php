    ...
    <div class="grid gap-6 md:grid-cols-2 md:col-span-2 lg:col-span-3">
      <div class="p-3 bg-red-50 rounded lg:p-5 lg:transition lg:duration-300 lg:hover:bg-red-100">
        <div class="flex items-center mb-1">
          ...
          <p class="text-lg font-semibold sm:text-base">Front end developer</p>
        </div>
        <p class="text-sm text-gray-900 font-">
      ...
      <div class="p-3 bg-yellow-50 rounded lg:p-5 lg:transition lg:duration-300 lg:hover:bg-yellow-100">
        <div class="flex items-center mb-1">
          ...
          <p class="text-lg font-semibold sm:text-base">Full stack developer</p>
        </div>
      ...
      <div class="p-3 bg-green-50 rounded lg:p-5 lg:transition lg:duration-300 lg:hover:bg-green-100">
        ...
        <p class="text-sm text-gray-900">
          Experience in database design using SQL and PHP, written in the Laravel framework.
      ...
      <div class="p-3 bg-blue-50 rounded lg:p-5 lg:transition lg:duration-300 lg:hover:bg-blue-100">
        ...
        <p class="text-sm text-gray-900">
          I spend about 10-30 minutes in my free time each day looking for these things from books, websites, communities. As for the time from 8 pm-6 pm,
          I will use it to develop a website that interests me. To improve my skills, I tried new tools that I had never used and continued to monitor my results.
        </p>
      </div>
    </div>
