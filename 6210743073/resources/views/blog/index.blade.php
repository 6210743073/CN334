...
<div class="bg-gray-100  text-center lg:py-12 lg:flex lg:justify-center " style="background-image: url(https://images.unsplash.com/photo-1642944267662-dacacac1132c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=342&q=80);">
    <div class="title">
...
<div>
    <div class="m-10 flex w-full max-w-sm mx-auto overflow-hidden bg-gray-800 rounded-lg ">
        ...
        <div class="px-4 py-2 -mx-3F">
            <div class="mx-3">
                ...
                <p class="text-sm text-gray-200 dark:text-gray-200">{{session()->get('message')}}</p>
            </div>
        </div>
    </div>
</div>
...
<div>
    <div class="w-full h-full bg-white p-13">
